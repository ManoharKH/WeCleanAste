...
public class AdminWorkInProgressFragment extends Fragment implements ComplaintAdminAdapter.ComplaintAdminClickInterface{
    ...
    public AdminWorkInProgressFragment() {
        // Required empty public constructor
    }

    public static AdminWorkInProgressFragment newInstance(String param1, String param2) {
        AdminWorkInProgressFragment fragment = new AdminWorkInProgressFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_admin_work_in_progress, container, false);
    ...
    private void getAdminComplaint() {
        ...
        databaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                if(admin_status.equals("Driver Added")) {
