...
public class AdminPendingComplaintFragment extends Fragment implements ComplaintAdminAdapter.ComplaintAdminClickInterface {
    ...
    public AdminPendingComplaintFragment() {
        // Required empty public constructor
    }

    public static AdminPendingComplaintFragment newInstance(String param1, String param2) {
        AdminPendingComplaintFragment fragment = new AdminPendingComplaintFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_admin_pending_complaint, container, false);
